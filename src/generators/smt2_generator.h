...
std::string reach_to_smt2(std::vector<modet *>, std::vector<box>);
std::string reach_c_to_smt2(std::vector<modet *>, std::vector<box>);
std::string reach_c_to_smt2(int, std::vector<modet *>, std::vector<box>);

...
std::pair<box, box> update_beta_dist(std::vector<box>, box, box, box);
std::pair<double, double> solve_beta_system(double, double, double, double);
double *sobol_vector(box); //new
double *nond(box);         //new
void func(std::vector<double> &vect, box);
} // namespace rnd
